...
@interface KTThumbsViewController ()
...
@synthesize isDecelerating, isDragging;
...
- (void)thumbsView:(KTThumbsView *)thumbsView visibleIndicesFrom:(NSInteger)startIndex until:(NSInteger)stopIndex {
    [dataSource_ downloadIndicesFrom:startIndex until:stopIndex];
    if (!(isDragging || isDecelerating))
        [dataSource_ startDownload];
}
